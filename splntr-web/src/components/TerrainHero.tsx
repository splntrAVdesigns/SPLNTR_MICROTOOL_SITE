 ...
 * blue, fading into the void toward the horizon. Mirrors the wireframe
 * grid/terrain aesthetic of the SPLNTR brand.
 *
 * Self-contained (plain React + three + @react-three/fiber) so it can be
 * lifted into other React environments if needed.
 *
 * Performance rules baked in:
 *  - DPR capped at 1.75
 *  - Reduced segment count on small screens
 *  - Honors prefers-reduced-motion (renders a static frame)
 *  - Pauses when the tab is hidden (r3f default) and demand-invalidates nothing per-frame in React
 */
