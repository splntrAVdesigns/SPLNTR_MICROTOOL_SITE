...
export const metadata: Metadata = {
  title: "Micro Tools",
  description:
    "The SPLNTR lineup — BlendCraft Studio, Orbital Visualizer, Harmony Compass, and SPLNTR Slicer Pro. Audio and visual micro tools in closed beta.",
};
    ...
    <div className="mx-auto max-w-6xl px-5 py-20">
      ...
      <section id="waitlist" className="mt-20 scroll-mt-24">
        ...
        <p className="mt-2 max-w-lg text-sm text-haze">
          One list covers the whole lineup — tell us what you make and we&apos;ll match you
          to the right beta wave.
        </p>
        <div className="mt-6">
          <WaitlistForm />
        </div>
